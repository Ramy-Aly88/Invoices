        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">مجمع عدد الفواتير</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    <p class="mb-0 tx-12 text-white op-7">إجمالى عدد كل الفواتير</p>
                                {{\App\invoices::count()}}
                                    <p class="mb-0 tx-12 text-white op-7">إجمالى مبلغ كل الفواتير</p>
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    <p class="mb-0 tx-12 text-white op-7"> مبلغ كل الفواتير الغير مدفوعة</p>
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    ...
                                    <p class="mb-0 tx-12 text-white op-7">مبلغ كل الفواتير المدفوعة جزئيا</p>
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    <p class="mb-0 tx-12 text-white op-7">عدد كل الفواتيرالمدفوعة كليا</p>
